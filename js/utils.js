    ...
    function (md5) {
        ...
        var Re = {
            ...
            ConvertDateToStr: function (date, formart) {
                ...
                } else if (formart == "hh:mm:ss") {
                    return info.hour + ":" + info.min + ":" + info.second;
            ...
            timestampToTimeStr: function (timestamp, splitr) {
                var Re = "";
                try {
                    timestamp = parseFloat(timestamp);
                    ...
                    if (time < 10 * 1) {
                        ...
                        if (splitr) {
                            if (nowDateInfo.year === dateInfo.year) {
                                Re = dateInfo.monthStr + "." + dateInfo.dayStr;
                            }
                            else {
            ...
            isMobile: function (para) {
                ...
                var phone_area = /^0\d{2,3}-?[2-9]\d{6,7}$/;
                var phone_area_other = /^0\d{2,3}-?[2-9]\d{6,7}-?\d{1,4}$/;
                var phone_noarea = /^\d{7,8}$/;
                if (phone_area.test(para) || phone_noarea.test(para) || phone_area_other.test(para)) {
                    return true;
                } else {
                    return false;
                }
