define(["utils"],function(utils){
  function getAbsulotePosition(obj) {
    ...
    var DatePicker = function () {
        ...
        me.DTP_Obj = [];
        me.mapping = {
            "yyyy": { "label": "年", "start": 1950, "end": 2040 },
            "MM": { "label": "月", "start": 1, "end": 12 },
            "dd": { "label": "日", "start": 1, "end": 31 },
            "hh": { "label": "时", "start": 0, "end": 23 },
            "mm": { "label": "分", "start": 0, "end": 59 }
        };
        ...
        CancelCol.className = "tmpk-top-col tmpk-cancel";
        CancelCol.innerHTML = "取消";
    ...
    DatePicker.prototype = {
        ...
        "_InitEvent": function () {
            ...
            function TouchEnd(e) {
                ...
                if (touchDuring < 350 && Math.abs(touchDiff) > 10) {
                    delta = me.getCanScrollValue(me.getCanScrollMaxHeight(listMappingInfo), touchDiff);

                }
                curObjInfo.y = me.getRealPosY(curObjInfo.y + delta, me.getLimit(listMappingInfo), curObjInfo);
                curObjInfo.obj.style[me.transition] = me.transform + " .5s cubic-bezier(0.333333, 0.666667, 0.666667, 1) 0s";
        ...
        _transitionEnd: function (e) {
            var me = this;
            var CurObj = me.DTP_Obj[e.target.getAttribute("index")];
        ...
        getCanScrollValue: function (canScrollMaxHeight, touchDiff) {
            ...
            if (touchDiff > me.itemHeight * me.rowsCount * 3 / 4) {
                //console.log("1: " + ( canScrollMaxHeight * dir * 0.6));
                return canScrollMaxHeight * dir * 0.9;
            }
            else if (touchDiff <= me.itemHeight * me.rowsCount * 3 / 4 && touchDiff > me.itemHeight * me.rowsCount * 2 / 4) {
                //console.log("2: " + (canScrollMaxHeight * dir * 0.2));
                return canScrollMaxHeight * dir * 0.7;
            }
            else if (touchDiff <= me.itemHeight * me.rowsCount * 2 / 4 && touchDiff > me.itemHeight * me.rowsCount * 1 / 4) {
                return me.itemHeight * 2 * dir;
            }
            else {
                //console.log("3: " + (itemHeight * 2 * dir));
                return me.itemHeight * dir;
            }
        },
