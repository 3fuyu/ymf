...
function(utils, baseClass, swiper) {
  ...
  function DayItem(dateInfo, itemStyle,dayWidth,calendar) {
    ...
    this.dayLabel = $("<div style='font-size:"+utils.fontSize12()+"px;width:"+dayWidth+"px;height:"+dayWidth+"px;line-height:"+(dayWidth-6)+"px' class='wc-calendar-day'>"+dateInfo.day +"</div>");
    if(isSelected){
      this.selected();
    }
  ...
  function weekCalendar(config){
    ...
    var wrapHeight = config.labelBarHeight + config.itemHeight;
    this.$el = $("<div  style='top:"+config.top+"px;height:"+wrapHeight+"px' class='wc-week-calendar displayflex flex-v displaynone'></div>");
  ...
  var Component = function(config) {
    ...
    this.innerWrapperTop = utils.getRealHeight(12);
  ...
  */
  ...
  Component.prototype.initYearAndMonthPicker = function(height, wrapperHeight,mt,mb) {
    ...
    var _top = utils.getRealWidth(5);
    var _this = this;//top:"+_top+"px;
    this.SwicthWapper = $("<div style='height:" + height + "px;margin-bottom:"+mb+"px;margin-top:"+mt+"px;border-radius:"+(height/2+4)+"px' class='wc-calendar-ym-picker displayflex flex-h'></div>");

    this.monthLeftIcon = $("<div class='wc-calendar-picker-lefticon' style='width:" + height + "px;height:" + height + "px;line-height:" + height + "px'></div>");
    ...
    this.monthRightIcon = $("<div class='wc-calendar-picker-righticon' style='width:" + height + "px;height:" + height + "px;line-height:" + height + "px'></div>");
